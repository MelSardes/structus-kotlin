...
**Structus** a été créé par **[Mel Sardes](https://github.com/melsardes)**, un ingénieur logiciel passionné par l'architecture propre et la conception dirigée par le domaine.

### Contact

- 🐙 **GitHub**: [@melsardes](https://github.com/melsardes)
- 📧 **Email**: dev.melsardes@gmail.com
- 💼 **Projet**: [structus-kotlin](https://github.com/melsardes/structus-kotlin)
...
Consultez le [Guide de contribution](https://github.com/melsardes/structus-kotlin/blob/main/CONTRIBUTING.md) pour plus de détails.

## Licence

Structus est un logiciel open-source sous licence [MIT License](https://github.com/melsardes/structus-kotlin/blob/main/LICENSE).
...
**Créé avec ❤️ par [Mel Sardes](https://github.com/melsardes) pour la communauté Kotlin**