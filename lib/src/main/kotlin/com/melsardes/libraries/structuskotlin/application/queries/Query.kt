 ...
 * - **Optimized for reading**: Can bypass domain model for performance
 *
 * ## Query vs Command:
 ...
 * - Clearly identify queries in the codebase
 * - Enable type-safe query handler implementations
 * - Support architectural validation and static analysis
 * - Provide a common base for potential future extensions (e.g., query metadata, caching hints)
 */
