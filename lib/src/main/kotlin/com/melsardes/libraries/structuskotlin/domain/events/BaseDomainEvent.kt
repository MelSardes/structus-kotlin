...
public abstract class BaseDomainEvent(
    ...
    public val eventVersion: Int = 1,
    override val eventId: String = UUID.randomUUID().toString(),
    override val occurredAt: Instant = kotlin.time.Clock.System.now(),
    public val causationId: String? = null,
     ...
     */
    public fun eventType(): String = this::class.simpleName ?: "UnknownEvent"
