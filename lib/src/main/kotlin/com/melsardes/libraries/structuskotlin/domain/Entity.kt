 ...
 * Using an abstract class allows us to provide a concrete implementation of `equals()` and `hashCode()`
 * based on the entity's ID, ensuring consistent identity-based equality across all entities.
 *
